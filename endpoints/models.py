...
class MLAlgorithmStatus(models.Model):
    ...
    Attributes:
        ...
        mlalgorithm: The reference to corresponding MLAlgorithm.
    ...
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
    mlalgorithm = models.ForeignKey(MLAlgorithm, on_delete=models.CASCADE, related_name="status")
...
class MLRequest(models.Model):
    ...
    Attributes:
        ...
        mlalgorithm: The reference to MLAlgorithm used to compute response.
    '''
