...
from HouseCancellation.wsgi import registry
...
def deactivate_other_statuses(instance):
    old_statuses = MLAlgorithmStatus.objects.filter(mlalgorithm = instance.mlalgorithm,
...
class PredictView(views.APIView):
    def post(self, request, endpoint_name, format=None):
        ...
        algs = MLAlgorithm.objects.filter(endpoint__name = endpoint_name, status__status = algorithm_status, status__active=True)
